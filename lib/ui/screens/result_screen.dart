                  ...
                  child: Column(
                    children: [
                      if (isWin && provider.hasNextLevel) ...[
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: const Text('NEXT LEVEL', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18, letterSpacing: 1.5)),
                          ),
                        ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (provider.currentCategory != null && provider.currentLevel != null) {
                              provider.startQuiz(provider.currentCategory!, provider.currentLevel!);
                              Navigator.pop(context);
                            }
                          },
                          style: ElevatedButton.styleFrom(
